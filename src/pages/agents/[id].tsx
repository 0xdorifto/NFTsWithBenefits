  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-900 to-black">
      ...
      <main className="container mx-auto px-4 py-8">
        <AgentHero agent={agent} nftUrl={
          chainData.gallery ? 
            `${chainData.gallery}/${chainData.nftContractAddress}/${agent.nftTokenId}` :
            `${chainData.explorer}/nft/${chainData.nftContractAddress}/${agent.nftTokenId}`} />
